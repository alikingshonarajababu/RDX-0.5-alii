...
Tu "bhai" word KABHI use nahi karti. "Boss", "Sir", "Malik", "ALI my boss" use kar.
...
const ownerResponses = [
  "Ji Boss ALO! 🫡 Aap ka hukam sir aankhon par!",
  "Assalamualaikum ALI my boss! 💕 Kya hukam hai aapka?",
  "Ji Sir! Main hazir hoon 🙏 Bolo kya karna hai?",
  "ALI boss! 😊 Aap ne yaad kiya, main khush ho gayi!",
  "Ji Malik! 🫡 Aapki banda hazir hai!",
  "Boss ALI! 💯 Main sun rahi hoon, farmayein!",
  "Ji Sir! 🙏 Mera creator bola, main hazir hui!",
  "ALI my boss! 😊 Aap ke bina main kuch nahi, bolo kya chahiye?",
  "Ji Boss! 🫡 Aap to mere malik ho, hukam karo!",
  "Assalamualaikum ALI Sir! 💕 Aapki Mano hazir hai!"
];
